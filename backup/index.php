...
$route->post("/to_manager/{user_id}/postural_analysis/{postural_analysis_id}/posture_analysis", "PostureAnalysisReports:posture_analysis_reports");
...
$route->post("/exercises/exercise", "Exercises:exercise");
