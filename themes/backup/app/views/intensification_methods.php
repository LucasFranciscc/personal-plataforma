            ...
            <div class="card">
                <div class="card-body d-md-flex text-center">
                    ...
                    <a href="#" class="btn btn-primary font-w-600 my-auto text-nowrap ml-auto add-event"
                       data-toggle="modal" data-target="#create"><i class="fa fa-plus"></i> Cadastrar Método de
                        Intensificação</a>
                        ...
                        <?php foreach ($intensification_methods as $item) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-primary mb-2" data-toggle="modal" data-target="#update"
                                            data-id="<?= $item->id ?>"
                                            data-intensification_method="<?= $item->intensification_method ?>">
                                        <i class="fa fa-pen"></i> <span class="d-none d-xl-inline-block">Editar</span>
                                    </button>

                                    <a class="btn btn-danger mb-2" style="color: white"
                                       data-confirm="Você deseja excluir esse método de itensificação?"
                                       data-post="<?= url("/app/intensification_methods"); ?>"
                                       data-action="delete"
                                       data-id="<?= $item->id ?>">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control rounded"
                                                   ...
                                                   placeholder="Método de Intesificação">
                                        </div>
                                    </div>
