    ...
    <div class="col-12 col-md-12 mt-3">
        ...
        <div class="card">
            <div class="card-body d-md-flex text-center">
                ...
                <a href="#" class="btn btn-primary font-w-600 my-auto text-nowrap ml-auto add-event" data-toggle="modal" data-target="#createFile"><i class="fa fa-plus"></i> Enviar arquivo</a>
                                ...
                                <?php foreach ($files as $file) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-success mb-2" href="<?= url("/storage/{$file->upload}"); ?>" style="color: white;" download>
                                                <i class="fas fa-download"></i> <span class="d-none d-xl-inline-block">Download</span>
                                            </a>

                                            <a class="btn btn-danger mb-2" data-post="<?= url("/app/chat-get/{$student->id}/file"); ?>" data-confirm="Tem certeza que deseja deletar esse arquivo?" data-action="remove" data-upload="<?= $file->id ?>" style="color: white;">
...
<div class="modal fade" id="createFile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle1">Enviar arquivo</h5>
