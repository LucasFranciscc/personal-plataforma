    ...
    <div class="col-12 col-md-12 mt-3">
        ...
        <div class="card">
            <div class="card-body d-md-flex text-center">
                ...
                <a href="#" class="btn btn-primary font-w-600 my-auto text-nowrap ml-auto add-event" data-toggle="modal" data-target="#createVideo"><i class="fa fa-plus"></i> Enviar Video</a>
                                ...
                                <?php foreach ($videos as $video) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-success mb-2" href="<?= url("/storage/{$video->upload}"); ?>" style="color: white;" download>
                                                <i class="fas fa-download"></i> <span class="d-none d-xl-inline-block">Download</span>
                                            </a>

                                            <a class="btn btn-danger mb-2" data-post="<?= url("/app/chat-get/{$video->id}/file"); ?>" data-confirm="Tem certeza que deseja deletar esse vídeo?" data-action="remove" data-upload="<?= $video->id ?>" style="color: white;">
...
<div class="modal fade" id="createVideo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle1" aria-hidden="true">
