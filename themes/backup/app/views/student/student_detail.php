...
?>
                            ...
                            <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                                    ...
                                    <li class="nav-item active px-3 px-md-1 px-xl-3">
                                        <div class="media d-block d-flex text-left py-2">
                                            <img class="img-fluid  mr-3 rounded-circle"
                                                 src="<?= image($student->photo, 260, 260) ?>" width="54" alt="">
                                            <div class="media-body align-self-center mt-0  d-flex">
                                                <div class="message-content">
                                                    <h6 class="mb-1 font-weight-bold d-flex"
                                                        style="margin-top: 5px;"><?= $student->name ?></h6>
                                                </div>

                                                <div style="margin-left: 10px;">
                                                    <a class="btn btn-secondary mb-2"
                                                       href="<?= url("app/to_manager/{$student->id}/chat/files"); ?>"
                                                       style="color: white;">
                                                        <i class="fas fa-file"></i> <span
                                                                class="d-none d-xl-inline-block">Arquivos</span>
                                                    </a>

                                                    <a class="btn btn-secondary mb-2"
                                                       href="<?= url("app/to_manager/{$student->id}/chat/photos"); ?>"
                                                       style="color: white;">
                                                        <i class="fas fa-file-image"></i> <span
                                                                class="d-none d-xl-inline-block">Imagens</span>
                                                    </a>

                                                    <a class="btn btn-secondary mb-2"
                                                       href="<?= url("app/to_manager/{$student->id}/chat/videos"); ?>"
                                                       style="color: white;">
                                                        <i class="fas fa-file-video"></i> <span
                                                                class="d-none d-xl-inline-block">Videos</span>
                                                    </a>
                                                </div>
                                ...
                                <form class="typing-area" autocomplete="off">
                                    <div class="border-top theme-border px-2 py-3 d-flex position-relative chat-box">
                                        ...
                                        <input type="text" name="incoming_id" class="incoming_id"
                                               value="<?= $student->id ?>" hidden/>
                                        <input type="text" class="form-control mr-2 input-field" require id="message"
    ...
    <div class="modal fade bd-example-modal-lgg" id="uploadFile" tabindex="-1" role="dialog"
                                    ...
                                    <div class="document-content">
                                        ...
                                        <div class="line-h-1 h5">
                                            <a class="text-success edit-document"
                                               href="<?= url("/storage/{$file->upload}"); ?>" download>
                                                <i class="fas fa-download"></i>
                                            </a>

                                            <a class="text-danger delete-document" id="remove"
                                               data-remove="<?= url("/app/chat-get/{$student->id}/file"); ?>"
                                               data-action="remove" data-upload="<?= $file->id ?>">
    ...
    <div class="modal fade bd-example-modal-lgg" id="uploadPhoto" tabindex="-1" role="dialog"
         aria-labelledby="myLargeModalLabel10" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                          ...
                          <div class="documents list">
                            ...
                            <?php foreach ($photos as $photo) : ?>
                                <div class="document folder-documents">
                                    <div class="document-content">
                                        <div class="document-profile">
                                            <img src="<?= image($photo->upload, 60, 100) ?>" alt="avatar"
                                        ...
                                        <div class="line-h-1 h5">
                                            <a class="text-success edit-document"
                                               href="<?= url("/storage/{$photo->upload}"); ?>" download>
                                                <i class="fas fa-download"></i>
                                            </a>

                                            <a class="text-danger delete-document" id="remove"
                                               data-remove="<?= url("/app/chat-get/{$photo->id}/file"); ?>"
                                               data-action="remove" data-upload="<?= $photo->id ?>">
                                                <i class="icon-trash"></i>
                                            </a>
                                        </div>
                                    </div>
    ...
    <div class="modal fade bd-example-modal-lgg" id="uploadVideo" tabindex="-1" role="dialog"
         aria-labelledby="myLargeModalLabel10" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <?php foreach ($videos as $video) : ?>
                                <div class="document folder-documents">
                                    <div class="document-content">
                                        ...
                                        <div class="line-h-1 h5">
                                            <a class="text-success edit-document"
                                               href="<?= url("/storage/{$video->upload}"); ?>" download>
                                                <i class="fas fa-download"></i>
                                            </a>

                                            <a class="text-danger delete-document" id="remove"
                                               data-remove="<?= url("/app/chat-get/{$video->id}/file"); ?>"
                                               data-action="remove" data-upload="<?= $photo->id ?>">
                                                <i class="icon-trash"></i>
                                            </a>
                                        </div>
