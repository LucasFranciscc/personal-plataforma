                  ...
                  <div id="collapse<?= $a->id ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                      <div class="p-3">
                          ...
                          <strong>1) ALGUM MÉDICO JÁ DISSE QUE VOCÊ POSSUI ALGUM PROBLEMA DE CORAÇÃO OU PRESSÃO
                              ARTERIAL, E QUE SOMENTE DEVERIA REALIZAR ATIVIDADE FÍSICA SUPERVISIONADO POR PROFISSIONAIS
                              DE SAÚDE?</strong>
                          <p><?= $a->question1 ?></p>
                          <br>
                          ...
                          <strong>5) SEGUE ALGUM PLANO ALIMENTAR FEITO POR NUTRICIONISTA?5) VOCÊ POSSUI ALGUM PROBLEMA
                              ÓSSEO OU ARTICULAR, QUE PODE SER AFETADO OU AGRAVADO PELA ATIVIDADE FÍSICA?
                          </strong>
                          <p><?= $a->question5 ?></p>
                          <br>
                          ...
                          <strong>7) VOCÊ REALIZA ALGUM TIPO DE TRATAMENTO MÉDICO PARA PRESSÃO ARTERIAL OU PROBLEMAS
                              CARDÍACOS?</strong>
                          <p><?= $a->question7 ?></p>
                          <br>

                          <strong>8) VOCÊ REALIZA ALGUM TRATAMENTO MÉDICO CONTÍNUO, QUE POSSA SER AFETADO OU PREJUDICADO
                              COM A ATIVIDADE FÍSICA?</strong>
                          <p><?= $a->question8 ?></p>
                          <br>

                          <strong>9) VOCÊ JÁ SE SUBMETEU A ALGUM TIPO DE CIRURGIA, QUE COMPROMETA DE ALGUMA FORMA A
                              ATIVIDADE FÍSICA?
                          </strong>
                          <p><?= $a->question9 ?></p>
                          <br>
