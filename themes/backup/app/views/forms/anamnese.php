              ...
              <div class="card">
                  ...
                  <div id="collapse<?= $a->id ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                      <div class="p-3">
                          ...
                          <strong>1) VOCÊ POSSUI ALGUM PROBLEMA DE SAÚDE OU RESTRIÇÃO?</strong>
                          <p><?= $a->question1 ?></p>
                          <br>

                          <strong>2) VOCÊ POSSUI ALGUMA LESÃO OU LIMITAÇÃO MUSCULAR OU ÓSSEA?</strong>
                          <p><?= $a->question2 ?></p>
                          <br>

                          <strong>3) JÁ PASSOU POR ALGUM PROCEDIMENTO CIRÚRGICO?</strong>
                          <p><?= $a->question3 ?></p>
                          <br>

                          <strong>4) VOCÊ PRATICA OU JÁ PRATICOU ALGUMA ATIVIDADE FÍSICA REGULARMENTE?</strong>
                          <p><?= $a->question4 ?></p>
                          <br>

                          <strong>5) SEGUE ALGUM PLANO ALIMENTAR FEITO POR NUTRICIONISTA?</strong>
                          <p><?= $a->question5 ?></p>
                          <br>

                          <strong>6) EM QUAL LOCAL VOCÊ REALIZARÁ SEUS TREINOS?</strong>
                          <p><?= $a->question6 ?></p>
                          <br>

                          <strong>7) QUAIS OS DOIS PRINCIPAIS OBJETIVOS COM O TREINAMENTO?</strong>
                          <p><?= $a->question7 ?></p>
                          <br>

                          <strong>8) QUAL O TEMPO MÁXIMO QUE VOCÊ TEM PARA REALIZAR CADA SESSÃO DE TREINO?</strong>
                          <p><?= $a->question8 ?></p>
                          <br>
                      </div>
                  </div>
