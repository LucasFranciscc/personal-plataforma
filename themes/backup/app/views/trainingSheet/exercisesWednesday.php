    ...
    <div class="d-sm-flex">
        <div class="align-self-center">
            <ul class="nav nav-pills flex-column flex-sm-row" id="myTab" role="tablist">
                ...
                <li class="nav-item ml-0">
                    <a class="nav-link  py-2 px-4 px-lg-4" href="<?= url("app/to_manager/{$student->id}/training_sheet/{$trainingSheet->id}/exercises/monday"); ?>">
                        Segunda
                    </a>
                </li>
                ...
                <li class="nav-item ml-0 mb-2 mb-sm-0">
                    <a class="nav-link py-2 px-4 px-lg-4 active" href="<?= url("app/to_manager/{$student->id}/training_sheet/{$trainingSheet->id}/exercises/wednesday"); ?>">
                        Quarta
                    </a>
                </li>
