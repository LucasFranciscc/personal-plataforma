...
<div class="header-wrap header custom-navbar wow fadeInDown" data-wow-duration="2s" role="navigation">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="logo"><a href="<?= url("/"); ?>"><img src="<?= url("/shared/web/images/logo.png"); ?>" alt=""></a></div>
                <div class="logo2"><a href="<?= url("/"); ?>"><img src="<?= url("/shared/web/images/logo2.png"); ?>" alt=""></a></div>
                    ...
                    <div class="container"> <a class="navbar-brand" href="#">Menu</a>
                        <div class="collapse navbar-collapse" id="navbarColor01">
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item"> <a class="nav-link smoothScroll" href="#home">Home</a></li>
                                ...
                                <li class="nav-item"> <a class="nav-link smoothScroll" href="#price">Valores</a> </li>
                            </ul>
                        </div>
                    </div>
                </nav>
