        ...
        <div class="card">
            <div class="card-body d-md-flex text-center">
                ...
                <a href="#" class="btn btn-primary font-w-600 my-auto text-nowrap ml-auto add-event" data-toggle="modal"
                    data-target="#createWarning"><i class="fa fa-plus"></i> Cadastrar Aviso</a>
                            ...
                            <td>
                                ...
                                <div class="col-6">
                                    <button class="btn btn-primary mb-2" data-toggle="modal"
                                        data-target="#updateWarning" data-id="<?= $warning->id ?>"
                                ...
                                <div class="col-6">
                                    ...
                                    <a class="btn btn-danger mb-2" style="color: white"
                                        data-post="<?= url("/app/warnings/warning"); ?>" data-action="delete"
                                        data-confirm="Você deseja excluir esse aviso?" data-id="<?= $warning->id; ?>">
...
<div class="modal fade" id="createWarning" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle1"
    aria-hidden="true">
...
<div class="modal fade" id="updateWarning" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle1"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
