            ...
            <div class="card">
                <div class="card-body d-md-flex text-center">
                    ...
                    <form action="<?= url("/app/students"); ?>" method="post" enctype="multipart/form-data">
                        <div class="  d-flex  ">
                            <input type="text" class="form-control col-md-12" placeholder="Pesquisar ..." name="s"
                                   id="s" value="<?= $search ?>" autocomplete="off"/>
                            <button class="btn btn-primary font-w-600 "
                                    style="position: initial; line-height: 15px; margin-left: 5px">
                    ...
                    <a href="#" class="btn btn-primary font-w-600 my-auto text-nowrap ml-auto add-event"
                       data-toggle="modal" data-target="#createStudent"><i class="fa fa-plus"></i> Cadastrar aluno</a>
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-image business-card">
                                ...
                                <div class="holder-image">
                                    <img src="<?= image($student->photo, 260, 260) ?>" alt="" class="img-fluid"
                                         style="max-width: 75%;">
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row mt-4 mb-3">
                                    <div class="col-5">
                                        <button class="btn btn-primary mb-2" data-toggle="modal"
                                                data-target="#updateStudent" data-id="<?= $student->id ?>"
                                                data-name="<?= $student->name ?>" data-birth="<?= $student->birth ?>"
                                                data-phone="<?= $student->phone ?>" data-cpf="<?= $student->cpf ?>"
                                                data-sex="<?= $student->sex ?>"
                                                data-level="<?= $student->access_level_id ?>"
                                                data-profession="<?= $student->profession ?>"
                                                data-email="<?= $student->email ?>"
                                                data-status="<?= $student->status ?>"
                                                data-zip_code="<?php if (!empty($student->student_address())) : ?><?= $student->student_address()->zip_code ?><?php else : ?><?php endif ?>"
                                                data-address="<?php if (!empty($student->student_address())) : ?><?= $student->student_address()->address ?><?php else : ?><?php endif ?>"
                                                data-number="<?php if (!empty($student->student_address())) : ?><?= $student->student_address()->number ?><?php else : ?><?php endif ?>"
                                                data-complement="<?php if (!empty($student->student_address())) : ?><?= $student->student_address()->complement ?><?php else : ?><?php endif ?>"
                                                data-district="<?php if (!empty($student->student_address())) : ?><?= $student->student_address()->district ?><?php else : ?><?php endif ?>"
                                                data-state="<?php if (!empty($student->student_address())) : ?><?= $student->student_address()->state ?><?php else : ?><?php endif ?>"
                                                data-city="<?php if (!empty($student->student_address())) : ?><?= $student->student_address()->city ?><?php else : ?><?php endif ?>">
                                            <i class="fa fa-pen"></i> Editar
                                        </button>
                                    </div>
                                    <div class="col-7">
                                        <a class="btn btn-primary mb-2" style="color: white;"
                                           href="<?= url("app/to_manager/{$student->id}/training_sheet"); ?>">
...
<?= $paginator; ?>
    ...
    <div class="modal fade" id="createStudent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle1"
         aria-hidden="true">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control mask-doc" id="cpf" name="cpf"
                                                   placeholder="CPF">
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control mask-cep" id="cep" name="zip_code"
                                                   value="" placeholder="CEP" onblur="pesquisacep(this.value);">
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="updateStudent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle1"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="cep">CEP</label>
                                            <input type="text" class="form-control mask-cep" id="cep" name="zip_code"
                                                   value="" placeholder="CEP" onblur="pesquisacepUpdate(this.value);">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="district">Bairro</label>
                                            <input type="text" class="form-control" id="districtUpdate" name="district"
                                                   placeholder="Bairro">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="state">Estado</label>
                                            <input type="text" class="form-control" id="stateUpdate" name="state"
                                                   placeholder="Estado">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="complement">Complemento</label>
                                            <input type="text" class="form-control" id="complementUpdate"
                                                   name="complement" placeholder="Complemento">
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label for="number">Número</label>
                                            <input type="text" class="form-control" id="numberUpdate" name="number"
                                                   placeholder="Número">
                                        </div>
                                    </div>
