...
<div class="row">
    ...
    <?php if ($birthdays) : ?>
        ...
        <?php foreach ($birthdays as $birthday) : ?>
            ...
            <!--                                            <a href="#"><img src="--><? //= image($birthday->photo, 30, 30) 
                                                                                        ?>
            <!--" alt=""-->
            <!--                                                             class="img-fluid ml-0 mt-2  rounded-circle" width="40"></a>-->
            <!--                                            <div class="media-body align-self-center pl-2">-->
            <!--                                                <span class="mb-0 font-w-600">--><? //= $birthday->name 
                                                                                                    ?>
            <!--</span>-->
            <!--                                                <br>-->
            <!--                                                <p class="mb-0 font-w-500 tx-s-12">--><? //= birth($birthday->birth) 
                                                                                                        ?>
            <!--</p>-->
            <!--                                            </div>-->
            <!--                                        </div>-->
                                    ...
                                    <div class="card mt-3 border-bottom-0">
                                        <div class="card-content border-bottom border-warning border-w-5">
                                            <div class="card-body p-4">
                                                ...
                                                <p class="font-w-500 tx-s-12"><i class="icon-calendar"></i> <?= date_fmt_br($warning->created_at) ?>
                                                </p>

                                                <div class="d-flex">
                                                    <img src="<?= image($warning->user()->photo, 30, 30) ?>" alt="author" width="30" class="rounded-circle">
    ...
    <div class="col-md-6 col-lg-12 mt-3">
        <div class="card border  h-100 notes-list-section">
            ...
            <div class="card">
                <a href="#" class="btn btn-outline-primary font-w-900 my-auto  add-event" data-toggle="modal" data-target="#createEvent"><i class="fa fa-plus"></i> Criar Evento</a>
            </div>
            ...
            <div class="row notes">
                ...
                <?php if ($events) : ?>
                    ...
                    <?php foreach ($events as $event) : ?>
                        ...
                        <div class="col-12  col-md-6 col-lg-4 my-3 note <?= $event->priority ?>" data-type="business-note">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body p-4">
                                        ...
                                        <p class="font-w-500 tx-s-12"><i class="icon-calendar"></i> <span class="note-date"><?= date_fmt($event->date_event, 'd/m/Y') ?> <?= $event->hour_event ?></span>
                                        </p>
                                        ...
                                        <div class="d-flex notes-tool">
                                            ...
                                            <div class="skin skin-flat">
                                                <a class="text-success edit-note" data-toggle="modal" data-target="#updateEvent" data-id="<?= $event->id ?>" data-event="<?= $event->event ?>" data-date="<?= $event->date_event ?>" data-hour="<?= $event->hour_event ?>" data-priority="<?= $event->priority ?>">
                                                    <i class="icon-pencil"></i>
                                                </a>

                                                <a class="text-danger delete-note" href="#" data-confirm="Você deseja deletar esse evento?" data-post="<?= url("/app/events/event"); ?>" data-action="delete" data-event_id="<?= $event->id ?>">
...
<div class="modal fade" id="createEvent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle1" aria-hidden="true">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="event" id="event" rows="7" class="form-control" required></textarea>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div style="margin-top: 30px; margin-left: 5px">
                                        <ul class="list list-unstyled mr-3">
                                            <li>
                                                ...
                                                <label class="note-content mb-0 font-w-300" for="priority" style="font-size: 15px">Prioridade</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<div class="modal fade" id="updateEvent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle1">Criar Evento</h5>
