...
<div class="row">
    ...
    <div class="card-body">
        <div class="col-12">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    <iframe width="512" height="281" src="https://www.youtube.com/embed/<?= $exercises->video_code ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
