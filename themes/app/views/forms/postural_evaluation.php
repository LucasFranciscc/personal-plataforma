                      ...
                      <div class="card-header" id="headingOne">
                          <h5 class="mb-0">
                            ...
                            <?php if ($a->status == 0): ?>
                                ...
                                data-post="<?= url("/app/avaliado") ?>" data-id="<?= $a->id ?>">Não Avaliado</a>
                            <?php else: ?>
                                <a class="btn btn-success" style="color: #FFFFFF"
                                   data-post="<?= url("/app/naoAvaliado") ?>" data-id="<?= $a->id ?>">Avaliado</a>
                            <?php endif; ?>
                              ...
                              <div class="col-12  mt-3">
                                  ...
                                  <div id="grid" class="row">
                                      ...
                                      <div class="item col-12 col-md-6 col-lg-4 mb-4 text-center Branding">
                                          ...
                                          <img src="<?= image($a->photo1, 250, 240) ?>" alt=""
                                               class="portfolioImage img-fluid">
                                          <div class="d-flex">
                                              <a data-fancybox-group="gallery"
                                                 href="<?= url("/storage/{$a->photo1}"); ?>"
                                                 class="fancybox btn rounded-0 btn-dark w-50">Ver Imagem</a>
                                              <a href="<?= url("/storage/{$a->photo1}"); ?>"
                                                 class="btn btn-success rounded-0 w-50" download>Download</a>
                                          </div>
                                      ...
                                      <div class="item col-12 col-md-6 col-lg-4 mb-4 text-center Branding">
                                          ...
                                          <img src="<?= image($a->photo2, 250, 240) ?>" alt=""
                                               class="portfolioImage img-fluid">
                                          <div class="d-flex">
                                              <a data-fancybox-group="gallery"
                                                 href="<?= url("/storage/{$a->photo2}"); ?>"
                                                 class="fancybox btn rounded-0 btn-dark w-50">Ver Imagem</a>
                                              <a href="<?= url("/storage/{$a->photo2}"); ?>"
                                                 class="btn btn-success rounded-0 w-50" download>Download</a>
                                          </div>
                                      ...
                                      <div class="item col-12 col-md-6 col-lg-4 mb-4 text-center Branding">
                                          ...
                                          <img src="<?= image($a->photo3, 250, 240) ?>" alt=""
                                               class="portfolioImage img-fluid">
                                          <div class="d-flex">
                                              <a data-fancybox-group="gallery"
                                                 href="<?= url("/storage/{$a->photo3}"); ?>"
                                                 class="fancybox btn rounded-0 btn-dark w-50">Ver Imagem</a>
                                              <a href="<?= url("/storage/{$a->photo3}"); ?>"
                                                 class="btn btn-success rounded-0 w-50" download>Download</a>
                                          </div>
                                      ...
                                      <div class="item col-12 col-md-6 col-lg-4 mb-4 text-center Branding">
                                          ...
                                          <img src="<?= image($a->photo4, 250, 240) ?>" alt=""
                                               class="portfolioImage img-fluid">
                                          <div class="d-flex">
                                              <a data-fancybox-group="gallery"
                                                 href="<?= url("/storage/{$a->photo4}"); ?>"
                                                 class="fancybox btn rounded-0 btn-dark w-50">Ver Imagem</a>
                                              <a href="<?= url("/storage/{$a->photo4}"); ?>"
                                                 class="btn btn-success rounded-0 w-50" download>Download</a>
                                          </div>
                                      ...
                                      <div class="item col-12 col-md-6 col-lg-4 mb-4 text-center Branding">
                                          ...
                                          <img src="<?= image($a->photo5, 250, 240) ?>" alt=""
                                               class="portfolioImage img-fluid">
                                          <div class="d-flex">
                                              <a data-fancybox-group="gallery"
                                                 href="<?= url("/storage/{$a->photo5}"); ?>"
                                                 class="fancybox btn rounded-0 btn-dark w-50">Ver Imagem</a>
                                              <a href="<?= url("/storage/{$a->photo5}"); ?>"
                                                 class="btn btn-success rounded-0 w-50" download>Download</a>
                                          </div>
                                      ...
                                      <div class="item col-12 col-md-6 col-lg-4 mb-4 text-center Branding">
                                          ...
                                          <img src="<?= image($a->photo6, 250, 240) ?>" alt=""
                                               class="portfolioImage img-fluid">
                                          <div class="d-flex">
                                              <a data-fancybox-group="gallery"
                                                 href="<?= url("/storage/{$a->photo6}"); ?>"
                                                 class="fancybox btn rounded-0 btn-dark w-50">Ver Imagem</a>
                                              <a href="<?= url("/storage/{$a->photo6}"); ?>"
                                                 class="btn btn-success rounded-0 w-50" download>Download</a>
                                          </div>
                                      ...
                                      <div class="item col-12 col-md-6 col-lg-4 mb-4 text-center Branding">
                                          ...
                                          <img src="<?= image($a->photo7, 250, 240) ?>" alt=""
                                               class="portfolioImage img-fluid">
                                          <div class="d-flex">
                                              <a data-fancybox-group="gallery"
                                                 href="<?= url("/storage/{$a->photo7}"); ?>"
                                                 class="fancybox btn rounded-0 btn-dark w-50">Ver Imagem</a>
                                              <a href="<?= url("/storage/{$a->photo7}"); ?>"
                                                 class="btn btn-success rounded-0 w-50" download>Download</a>
                                          </div>
                                      ...
                                      <div class="item col-12 col-md-6 col-lg-4 mb-4 text-center Branding">
                                          ...
                                          <img src="<?= image($a->photo8, 250, 240) ?>" alt=""
                                               class="portfolioImage img-fluid">
                                          <div class="d-flex">
                                              <a data-fancybox-group="gallery"
                                                 href="<?= url("/storage/{$a->photo8}"); ?>"
                                                 class="fancybox btn rounded-0 btn-dark w-50">Ver Imagem</a>
                                              <a href="<?= url("/storage/{$a->photo8}"); ?>"
                                                 class="btn btn-success rounded-0 w-50" download>Download</a>
                                          </div>
                                      ...
                                      <div class="item col-12 col-md-6 col-lg-4 mb-4 text-center Branding">
                                          ...
                                          <img src="<?= image($a->photo9, 250, 240) ?>" alt=""
                                               class="portfolioImage img-fluid">
                                          <div class="d-flex">
                                              <a data-fancybox-group="gallery"
                                                 href="<?= url("/storage/{$a->photo9}"); ?>"
                                                 class="fancybox btn rounded-0 btn-dark w-50">Ver Imagem</a>
                                              <a href="<?= url("/storage/{$a->photo9}"); ?>"
                                                 class="btn btn-success rounded-0 w-50" download>Download</a>
                                          </div>
