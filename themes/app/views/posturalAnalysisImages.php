            ...
            <div class="card">
                <div class="card-body d-md-flex text-center">
                    ...
                    <a href="#" class="btn btn-primary font-w-600 my-auto text-nowrap ml-auto add-event"
                       data-toggle="modal" data-target="#createPosturalAnalysisImage"><i class="fa fa-plus"></i>
                        Cadastrar Imagens
                    </a>
                ...
                <?php foreach ($data as $a) : ?>
                    <div class="card">
                        <div class="card-header" id="headingOne">
                            ...
                            <h6 class="mb-0">
                                ...
                                <button class="btn btn-link collapsed" data-toggle="collapse"
                                        data-target="#collapse<?= $a->id ?>" aria-expanded="false"
                                ...
                                <a class="btn btn-danger font-w-600 my-auto text-nowrap ml-auto add-event"
                                   style="color: #fff;" data-confirm="Você desejá excluir essa análise postural?"
                                   data-post="<?= url("app/delete_postural_analysis_images/{$student->id}"); ?>"
                                   data-postural_analysis_id="<?= $a->id ?>"><i class="fas fa-close"></i>
                                    Excluir
                                </a>
                            </h6>
                        </div>
                        ...
                        <div id="collapse<?= $a->id ?>" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <?php $posturalAnalysisImage = (new \Source\Models\PosturalAnalysisImages())->find("postural_analysis_id = :id", "id={$a->id}")->order("position")->fetch(true); ?>
                                                    ...
                                                    <div class="col-md-6 col-lg-4 col-4 mb-4">
                                                        <div class="position-relative"
                                                            ...
                                                            <img src="<?= url("storage/" . $posturalAnalysisImage[0]->image) ?>"
                                                                 alt="" class="img-fluid imagem-padrao">
                                                                ...
                                                                <div class="d-table w-100 h-100 ">
                                                                    <div class="d-table-cell align-bottom">
                                                                        ...
                                                                        <div class="mb-3" style="text-align: center">
                                                                            <a data-post="<?= url("/app/postural_analysis/position") ?>"
                                                                               data-position="<?= $posturalAnalysisImage[0]->position ?>"
                                                                               data-postural_analysis_id="<?= $a->id ?>"
                                                                               data-action="down"
                                                            ...
                                                            <div class="caption-bg fade bg-transparent text-right">
                                                                <div class="d-table w-100 h-100 ">
                                                                    <div class="d-table-cell align-bottom">
                                                                        ...
                                                                        <?php if (count($posturalAnalysisImage) <= 2): ?>
                                                                            <div class="mb-3" style="text-align: center">
                                                                                <a data-post="<?= url("/app/postural_analysis/position") ?>"
                                                                                   data-position="<?= $posturalAnalysisImage[1]->position ?>"
                                                                                   data-postural_analysis_id="<?= $a->id ?>"
                                                                                   data-action="up" class="btn btn-success">
                                                            ...
                                                            <div class="caption-bg fade bg-transparent text-right">
                                                                <div class="d-table w-100 h-100 ">
                                                                    <div class="d-table-cell align-bottom">
                                                                        ...
                                                                        <?php if (count($posturalAnalysisImage) <= 3): ?>
                                                                            <div class="mb-3" style="text-align: center">
                                                                                <a data-post="<?= url("/app/postural_analysis/position") ?>"
                                                                                   data-position="<?= $posturalAnalysisImage[2]->position ?>"
                                                                                   data-postural_analysis_id="<?= $a->id ?>"
                                                                                   data-action="up" class="btn btn-success">
                                                                                    <i class="fa fa-angle-double-up"></i></a>
                                                                            </div>
                                                            ...
                                                            <div class="caption-bg fade bg-transparent text-right">
                                                                <div class="d-table w-100 h-100 ">
                                                                    <div class="d-table-cell align-bottom">
                                                                        ...
                                                                        <?php if (count($posturalAnalysisImage) <= 4): ?>
                                                                            <div class="mb-3" style="text-align: center">
                                                                                <a data-post="<?= url("/app/postural_analysis/position") ?>"
                                                                                   data-position="<?= $posturalAnalysisImage[3]->position ?>"
                                                                                   data-postural_analysis_id="<?= $a->id ?>"
                                                                                   data-action="up" class="btn btn-success">
                                                                                    <i class="fa fa-angle-double-up"></i></a>
                                                                            </div>
                                                            ...
                                                            <div class="caption-bg fade bg-transparent text-right">
                                                                <div class="d-table w-100 h-100 ">
                                                                    <div class="d-table-cell align-bottom">
                                                                        ...
                                                                        <?php if (count($posturalAnalysisImage) <= 5): ?>
                                                                            <div class="mb-3" style="text-align: center">
                                                                                <a data-post="<?= url("/app/postural_analysis/position") ?>"
                                                                                   data-position="<?= $posturalAnalysisImage[4]->position ?>"
                                                                                   data-postural_analysis_id="<?= $a->id ?>"
                                                                                   data-action="up" class="btn btn-success">
                                                                                    <i class="fa fa-angle-double-up"></i></a>
                                                                            </div>
                                                            ...
                                                            <div class="caption-bg fade bg-transparent text-right">
                                                                <div class="d-table w-100 h-100 ">
                                                                    <div class="d-table-cell align-bottom">
                                                                        ...
                                                                        <?php if (count($posturalAnalysisImage) <= 6): ?>
                                                                            <div class="mb-3" style="text-align: center">
                                                                                <a data-post="<?= url("/app/postural_analysis/position") ?>"
                                                                                   data-position="<?= $posturalAnalysisImage[5]->position ?>"
                                                                                   data-postural_analysis_id="<?= $a->id ?>"
                                                                                   data-action="up" class="btn btn-success">
                                                                                    <i class="fa fa-angle-double-up"></i></a>
                                                                            </div>
                                                            ...
                                                            <div class="caption-bg fade bg-transparent text-right">
                                                                <div class="d-table w-100 h-100 ">
                                                                    <div class="d-table-cell align-bottom">
                                                                        ...
                                                                        <?php if (count($posturalAnalysisImage) <= 7): ?>
                                                                            <div class="mb-3" style="text-align: center">
                                                                                <a data-post="<?= url("/app/postural_analysis/position") ?>"
                                                                                   data-position="<?= $posturalAnalysisImage[6]->position ?>"
                                                                                   data-postural_analysis_id="<?= $a->id ?>"
                                                                                   data-action="up" class="btn btn-success">
                                                                                    <i class="fa fa-angle-double-up"></i></a>
                                                                            </div>
                                                            ...
                                                            <div class="caption-bg fade bg-transparent text-right">
                                                                <div class="d-table w-100 h-100 ">
                                                                    <div class="d-table-cell align-bottom">
                                                                        ...
                                                                        <?php if (count($posturalAnalysisImage) <= 8): ?>
                                                                            <div class="mb-3" style="text-align: center">
                                                                                <a data-post="<?= url("/app/postural_analysis/position") ?>"
                                                                                   data-position="<?= $posturalAnalysisImage[7]->position ?>"
                                                                                   data-postural_analysis_id="<?= $a->id ?>"
                                                                                   data-action="up" class="btn btn-success">
                                                                                    <i class="fa fa-angle-double-up"></i></a>
                                                                            </div>
                                                            ...
                                                            <div class="caption-bg fade bg-transparent text-right">
                                                                <div class="d-table w-100 h-100 ">
                                                                    <div class="d-table-cell align-bottom">
                                                                        ...
                                                                        <?php if (count($posturalAnalysisImage) <= 9): ?>
                                                                            <div class="mb-3" style="text-align: center">
                                                                                <a data-post="<?= url("/app/postural_analysis/position") ?>"
                                                                                   data-position="<?= $posturalAnalysisImage[8]->position ?>"
                                                                                   data-postural_analysis_id="<?= $a->id ?>"
                                                                                   data-action="up" class="btn btn-success">
                                                                                    <i class="fa fa-angle-double-up"></i></a>
                                                                            </div>
                                                            ...
                                                            <div class="caption-bg fade bg-transparent text-right">
                                                                <div class="d-table w-100 h-100 ">
                                                                    <div class="d-table-cell align-bottom">
                                                                        ...
                                                                        <?php if (count($posturalAnalysisImage) <= 10): ?>
                                                                            <div class="mb-3" style="text-align: center">
                                                                                <a data-post="<?= url("/app/postural_analysis/position") ?>"
                                                                                   data-position="<?= $posturalAnalysisImage[9]->position ?>"
                                                                                   data-postural_analysis_id="<?= $a->id ?>"
                                                                                   data-action="up" class="btn btn-success">
                                                                                    <i class="fa fa-angle-double-up"></i></a>
                                                                            </div>
                                                            ...
                                                            <div class="caption-bg fade bg-transparent text-right">
                                                                <div class="d-table w-100 h-100 ">
                                                                    <div class="d-table-cell align-bottom">
                                                                        ...
                                                                        <?php if (count($posturalAnalysisImage) <= 11): ?>
                                                                            <div class="mb-3" style="text-align: center">
                                                                                <a data-post="<?= url("/app/postural_analysis/position") ?>"
                                                                                   data-position="<?= $posturalAnalysisImage[10]->position ?>"
                                                                                   data-postural_analysis_id="<?= $a->id ?>"
                                                                                   data-action="up" class="btn btn-success">
                                                                                    <i class="fa fa-angle-double-up"></i></a>
                                                                            </div>
...
<?php $v->start("scripts"); ?>
    ...
    <script>
        ...
        $('#createPosturalAnalysisImage').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget);
            var postural_analysis_id = button.data('postural_analysis_id');
