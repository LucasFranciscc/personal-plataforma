    ...
    <div class="xs-menu-top">
        <div class="container clearfix">
            <ul class="xs-header-contact">
                <li><i class="icon icon-map-marker2"></i> 1105 Rover Street, CA 94903</li>
            </ul>
    ...
    <div class="xs-container">
        <div class="xs-navbar">
            <a class="xs-navbar-brand" href="index.html">
                <img src="<?= url("/shared/landing1/images/logo/logo-white.png"); ?>" alt="navbar logo">
            </a>
                    ...
                    <div class="elementskit-nav-identity-panel">
                        <h1 class="elementskit-site-title">
                            <a class="elementskit-nav-logo" href="index.html">
                                <img src="<?= url("/shared/landing1/images/logo/logo-black.png"); ?>" alt="navbar logo">
                            </a>
                        </h1>
    ...
    <div class="row no-gutters">
        <div class="col-md-4">
            <div class="xs-service">
                <img src="<?= url("/shared/landing1/images/services/service1.jpg"); ?>" alt="service image">
        ...
        <div class="col-md-4">
            <div class="xs-service">
                <img src="<?= url("/shared/landing1/images/services/service2.jpg"); ?>" alt="service image">
                <div class="xs-overlay d-flex align-items-center">
                    <div class="xs-service-content">
                        <div class="xs-icon-wraper">
        ...
        <div class="col-md-4">
            <div class="xs-service">
                <img src="<?= url("/shared/landing1/images/services/service3.jpg"); ?>" alt="service image">
                <div class="xs-overlay d-flex align-items-center">
                    <div class="xs-service-content">
                        <div class="xs-icon-wraper">
...
<section class="xs-black-bg xs-section-padding-lg" data-scrollax-parent="true" id="health">
    <div class="xs-help xs-health">
        ...
        <div class="xs-water-mark medium-size" data-scrollax="properties: { translateY: '-250px' }">GYMvast</div>
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="xs-section-heading2">
                        <h2>Why gyming is good<br />
...
<section class="xs-section-padding xs-bg-cover class-schedule-area parallaxie parallaxie"
         style="background-image: url(<?= url("/shared/landing1/images/schedule-bg.jpg"); ?>);" data-scrollax-parent="true" id="schedule">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive xs-schedule-table-dark">
...
<section class="position-relative xs-black-bg xs-section-padding" data-scrollax-parent="true" id="price">
    ...
    <div class="xs-pricing-dark-shape xs-bg-cover" data-scrollax="properties: { translateY: '-250px' }"
         style="background-image: url(<?= url("/shared/landing1/images/shape/pricing-dark.png"); ?>);">
    </div>
    <div class="xs-pricing-dark">
        <div class="container">
            <div class="row no-gutters">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="xs-pricing isActive">
                        <h3 class="xs-line">Exterprise</h3>
                        <p>
                            <sup>$</sup>
                            <span>49</span>
                            <sub>/mo</sub>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="xs-pricing">
                        <h3 class="xs-line">Professional</h3>
                        <p>
                            <sup>$</sup>
                            <span>49</span>
                            <sub>/mo</sub>
...
<section class="xs-bg-cover xs-pt-50 xs-pb-sm parallaxie parallaxie"
         style="background-image: url(<?= url("/shared/landing1/images/bmi-bg.png"); ?>);">
    <div class="container">
        <div class="xs-bmi">
            <div class="row">
...
<section class="xs-black-bg xs-section-padding">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="xs-section-heading2 text-center">
        ...
        <div class="xs-shop-dark">
            <div class="row">
                <div class="col-lg-4">
                    <div class="xs-shop">
                        <div class="xs-shop-thumb">
                            <img src="<?= url("/shared/landing1/images/shop/shop-1.png"); ?>"" alt="shop">
                        </div>
                        <div class="xs-shop-inner">
                            <a href="#" class="btn btn-primary">Buy Now</a>
                            <div class="xs-price-wraper">
                ...
                <div class="col-lg-4">
                    <div class="xs-shop">
                        <div class="xs-shop-thumb">
                            <img src="<?= url("/shared/landing1/images/shop/shop-2.png"); ?>"" alt="shop">
                        </div>
                        <div class="xs-shop-inner">
                            <a href="#" class="btn btn-primary">Buy Now</a>
                            <div class="xs-price-wraper">
                ...
                <div class="col-lg-4">
                    <div class="xs-shop">
                        <div class="xs-shop-thumb">
                            <img src="<?= url("/shared/landing1/images/shop/shop-3.png"); ?>" alt="shop">
                        </div>
                        <div class="xs-shop-inner">
                            <a href="#" class="btn btn-primary">Buy Now</a>
                            <div class="xs-price-wraper">
...
<section class="position-relative xs-section-padding xs-bg-cover parallaxie parallaxie"
         style="background-image: url(<?= url("/shared/landing1/images/testimonial/testimonial_img2.jpg"); ?>);">
            ...
            <div class="col-lg-9 mx-auto">
                ...
                <div class="owl-carousel owl-theme xs-testimonial-owl xs-testimonial-dark">
                    <div class="item">
                        ...
                        <div class="xs-testimonial-profile clearfix">
                            <div class="xs-profile-thumb">
                                <img src="<?= url("/shared/landing1/images/testimonial/testimonial-profile-1.png"); ?>" alt="testimonial">
                            </div>
                    ...
                    <div class="item">
                        ...
                        <div class="xs-testimonial-profile clearfix">
                            <div class="xs-profile-thumb">
                                <img src="<?= url("/shared/landing1/images/testimonial/testimonial-profile-2.png"); ?>"
                    ...
                    <div class="item">
                        ...
                        <div class="xs-testimonial-profile clearfix">
                            <div class="xs-profile-thumb">
                                <img src="<?= url("/shared/landing1/images/testimonial/testimonial-profile-3.png"); ?>"
                                     class="rounded-circle" alt="testimonial">
                            </div>
                            <div class="xs-profile-info">
                                <h3>Dev Smith</h3>
                    ...
                    <div class="item">
                        ...
                        <div class="xs-testimonial-profile clearfix">
                            <div class="xs-profile-thumb">
                                <img src="<?= url("/shared/landing1/images/testimonial/testimonial-profile-1.png"); ?>"
                                     class="rounded-circle" alt="testimonial">
                            </div>
                            <div class="xs-profile-info">
                                <h3>David William</h3>
            ...
            <div class="row">
                <div class="col-lg-7 col-md-8 mx-auto">
                    <div class="xs-section-heading text-center">
                        ...
                        <p>World is committed to making participation in the event harass ment free on experience
                            for everyone, regardless.</p>
                    </div>
                </div>
            </div>
            <form action="#" class="xs-form xs-form-dark xs-dark-shadow" id="xs-contact-form">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="form-text text-muted xs-mt-50">We do not sell, share, trade your information with
                            anyone for any reason. We won’t give spam mails.</p>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group xs-mt-60 text-right">
                            <button type="submit" id="xs_contact_submit" class="btn btn-primary">Submit Now <span
        ...
        <div class="row align-items-center">
            <div class="col-12">
                <div class="owl-carousel owl-theme xs-brand-owl">
                    <div class="item">
                        <img src="<?= url("/shared/landing1/images/brand/brand1.png"); ?>" alt="brand">
                    </div>
                    <div class="item">
                        <img src="<?= url("/shared/landing1/images/brand/brand2.png"); ?>" alt="brand">
                    </div>
                    <div class="item">
                        <img src="<?= url("/shared/landing1/images/brand/brand3.png"); ?>" alt="brand">
                    </div>
                    <div class="item">
                        <img src="<?= url("/shared/landing1/images/brand/brand4.png"); ?>" alt="brand">
                    </div>
                    <div class="item">
                        <img src="<?= url("/shared/landing1/images/brand/brand5.png"); ?>" alt="brand">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-widget xs-mr-35">
                        <div class="xs-footer-logo">
                            <img src="<?= url("/shared/landing1/images/logo/logo-red.png"); ?>" alt="logo">
                        </div>
                    ...
                    <div class="footer-widget xs-footer-subscribe">
                        ...
                        <form action="#" method="POST" class="xs-subscribe-form">
                            <div class="form-group">
                                <input type="email" name="email" id="sub-input2" class="form-control"
