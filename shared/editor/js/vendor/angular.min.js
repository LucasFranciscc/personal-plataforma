...
(function (M, Y, t) {
                            ...
                            a:do {
                                if (m = t.$$watchers) for (u = m.length; u--;) try {
                                    if (e = m[u]) if ((g = e.get(t)) !== (l = e.last) && !(e.eq ? fa(g, l) : "number" === typeof g && "number" === typeof l && isNaN(g) && isNaN(l))) v =
                                        !0, c = e, e.last = e.eq ? Ea(g, null) : g, e.fn(g, l === p ? g : l, t), 5 > s && (y = 4 - s, W[y] || (W[y] = []), W[y].push({
    ...
    function sd(b) {
        ...
        d.$setValidity = function (b, e, f) {
            ...
            d.$pending ? (a(xd, !0), d.$valid = d.$invalid = t, c("", null)) : (a(xd, !1), d.$valid = wd(d.$error), d.$invalid =
                !d.$valid, c("", d.$valid));
    ...
    var Of = /^\/(.+)\/([a-z]*)$/, Q = function (b) {
        ...
        ga = M.angular || (M.angular = {}), bb, nb = 0;
    Ra = Y.documentMode;
    H.$inject = [];
    pa.$inject = [];
    var D =
        ...
        }, rb = ["ng-", "data-ng-", "ng:", "x-ng-"], Md = /[A-Z]/g, uc = !1, Pb, oa = 1, pb = 3,
            ...
            return {
                restrict: "EA", link: function (f, g, h) {
                    ...
                    var k = h.count, m = h.$attr.when && g.attr(h.$attr.when), p = h.offset || 0, q = f.$eval(m) || {},
                        u = {}, m = c.startSymbol(), r = c.endSymbol(), t = m + k + "-" + p + r, n = ga.noop, v;
                    s(h, function (a, c) {
                        var d =
                            e.exec(c);
            ...
            return {
                ...
                link: function (e, g, h, l) {
                    ...
                    if (l[1]) {
                        ...
                        l = l[1];
                        var u = h.multiple,
                            r = h.ngOptions, z = !1, n, v = !1, w = B(Y.createElement("option")),
